    ...
    <div class="app-container">
      ...
      <tree-table ref="TreeTable"
        ...
        <template slot="timeline"
          ...
          <el-tooltip :content="scope.row.timeLine+'ms'"
                      effect="dark"
                      placement="left">
        ...
        <template slot="append"
          ...
          <el-button size="mini"
                     type="primary"
                     @click="addMenuItem(scope.row,'brother')">Append Brother
          </el-button>
          <el-button size="mini"
                     type="primary"
                     @click="addMenuItem(scope.row,'children')">Append Child
          </el-button>
        </template>
    ...
    <el-dialog :visible.sync="dialogFormVisible"
      ...
      <el-form :model="tempItem"
        ...
        <el-form-item label="Name">
          <el-input v-model.trim="tempItem.name"
                    placeholder="Name" />
        </el-form-item>
      </el-form>
      <span slot="footer"
        ...
        <el-button type="primary"
                   @click="updateItem">Confirm</el-button>
      </span>
    </el-dialog>
  </div>
</template>
